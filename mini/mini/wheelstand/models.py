...
class Trim(models.Model):
    ...
    name_fr = models.CharField(max_length=255,
                               ...
                               blank=True, null=True,
                               help_text=_('French'))
    power_en = models.TextField(max_length=255,  null=True, blank=True, verbose_name=('Power English'), help_text=_('English'))
    power_fr = models.TextField(max_length=255, null=True, blank=True, verbose_name=('Power French'), help_text=_('French'))
...
class FeaturesAccessory(models.Model):
    ...
    description_en = models.TextField(max_length=255, verbose_name=_('Description English'), help_text=_('English'))
    description_fr = models.TextField(max_length=255, verbose_name=_('Description French'), help_text=_('French'), blank=True, null=True)
...
class Package(models.Model):
    ...
    description_fr = models.TextField(max_length=255, help_text=_('French'), verbose_name=_('Description French'), blank=True, null=True)
